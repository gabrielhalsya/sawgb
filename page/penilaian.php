	    ...
	    <div class="panel panel-info">
	        ...
	        <div class="panel-body">
	            <table class="table table-condensed">
	                ...
	                <tbody>
	                    <?php $no = 1; ?>
	                    <?php if ($query = $connection->query("SELECT a.kd_penilaian, c.nama AS nama_periode, b.nama AS nama_kriteria, a.keterangan, a.bobot FROM penilaian a JOIN kriteria b ON a.kd_kriteria=b.kd_kriteria JOIN periode c ON a.kd_periode=c.kd_periode ORDER BY kd_penilaian
						 DESC")): ?>
